...
$(function() {
  $('#validate').click(function() {
    var val = $('#rawjson').val();
    //val = {a:1, 'b':'foo', c:[false,'false',null, 'null', {d:{e:1.3e5,f:'1.3e5'}}]};
    try {
        val = jsonlite.parse(val);
    } catch (exception) {
    ...
    var str = JSON.stringify(val, undefined, 4);
    output(syntaxHighlight(str));
  });
});
function output(inp) {
    document.getElementById("preetyjson").innerHTML = inp;
}
